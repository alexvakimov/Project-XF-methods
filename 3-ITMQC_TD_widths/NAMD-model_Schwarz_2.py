...
from recipes import shxf, mqcxf, ehxf, shxf_ssy
from recipes import ehrenfest_adi_ld, ehrenfest_adi_nac, ehrenfest_dia, mfsd
from recipes import fssh, sdm, bcsh, bcsh_ssy
...
if method_indx == 0:
    ...
    bcsh_ssy.load(dyn_general)  # PC-BCSH 
elif method_indx == 10:
    shxf_ssy.load(dyn_general)  # PC-SHXF 
...
wp_width = MATRIX(1,1); wp_width.set(0,0,2.0)
...
#nucl_params["force_constant"] = [0.1e-3]
#nucl_params["p"] = [10.0]
