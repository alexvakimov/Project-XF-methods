...
def load(dyn_general):
    ...
    dyn_general.update({"hop_acceptance_algo":10, "momenta_rescaling_algo":0 })  # accept and rescale based on total energy, do not rescale momenta, since the active state is just a "pointer-state" indicator.
    ...
    dyn_general.update({"wp_width":wp_width, "coherence_threshold": 0.01, "use_xf_force": 1 })
